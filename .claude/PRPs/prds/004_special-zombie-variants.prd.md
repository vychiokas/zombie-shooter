...
| 3 | Tank variant | Implement slow, high-HP zombie with larger hitbox and unique sprites | complete | with 2 | 1 | [phase-3-tank-variant.plan.md](../plans/completed/phase-3-tank-variant.plan.md) |
| 4 | Exploder variant | Implement explosion on death with AOE damage to player and zombies | complete | - | 1, 2, 3 | [phase-4-exploder-variant.plan.md](../plans/completed/phase-4-exploder-variant.plan.md) |
| 5 | Spitter variant | Implement ranged zombie with acid projectile attacks | complete | - | 1 | [phase-5-spitter-variant.plan.md](../plans/completed/phase-5-spitter-variant.plan.md) |
